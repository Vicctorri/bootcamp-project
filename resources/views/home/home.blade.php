                  ...
                  <div class="col-md-7 ">
                      ...
                      <p>The software helps to manage the entire library operations from maintaining book records to issue a book.
                        ...
                        <p> Here you can always find the relevant information on the available domains for your region.
                          ...
                          <a href="login.html" class="btn btn-outline-primary p-3 mb-md-5 fw-bold">SIGN IN</a>
                    </div>  
            ...
            <div class="col-md-6">
              <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner img2">
                  ...
                  <div class="carousel-item">
                    <img src="img/library6.webp" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="img/library7.webp" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="img/l.jpg" class="d-block w-100" alt="...">
                  </div>
                </div>
              </div>
            </div>
            <div class="about col shadow-sm ">
      ...
      <section id="contact">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12">
                    <div class="itd_circle"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
